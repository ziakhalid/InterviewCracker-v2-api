...
public class TopicController {
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/topicType/{topicType}")
    Collection<Topic> getTopicByTopicType(@PathVariable String topicType) {
    ...
    ResponseEntity<?> addTopic(@RequestBody Topic topic) {
        if (Util.save(topicRepository, new Topic(topic.getTopicType(), topic.getTopicName(), topic.getQuestionCount())) != null) {
